...
import net.trullyabunny.recorcfulbees.item.ModCreativeModeTab;
...
@Mod(RecorcfulBees.MODID)
public class RecorcfulBees {
    ...
    @EventBusSubscriber(modid = RecorcfulBees.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
